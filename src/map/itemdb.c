...
#else
	const char *config_filename = "db/"DBPATH"item_group.conf"; // FIXME hardcoded name
#endif
	const char *itname;
	int i = 0, count = 0, c;
...
#else
	const char *config_filename = "db/"DBPATH"item_packages.conf"; // FIXME hardcoded name
#endif
	const char *itname;
...
#else
	const char *config_filename = "db/"DBPATH"item_chain.conf"; // FIXME hardcoded name
#endif
	int i = 0, count = 0;
