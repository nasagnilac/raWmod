...
int read_mercenarydb(void) {
	...
	sv->readdb(map->db_path, DBPATH"mercenary_db.txt", ',', 26, 26, MAX_MERCENARY_CLASS, mercenary->read_db_sub);
...
int read_mercenary_skilldb(void) {
	sv->readdb(map->db_path, DBPATH"mercenary_skill_db.txt", ',', 3, 3, -1, mercenary->read_skill_db_sub);
